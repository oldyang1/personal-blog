...
def send_register_email(email, send_type='register'):
    ...
    if send_type == 'register':
        ...
        send_status = send_mail(email_title, email_body, 'xxxxxxxxxxxx@163.com', [email]) # 填写您的发送邮箱地址
        if send_status:
            pass
        ...
        send_status = send_mail(email_title, email_body, 'xxxxxxxxxx@163.com', [email])  # 填写您的发送邮箱地址
        if send_status:
            pass
